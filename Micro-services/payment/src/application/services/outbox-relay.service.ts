...
// Transactional Outbox relay: varre eventos PENDING gravados na mesma transação da mudança de estado
// e os publica em `payment-events` (key = aggregateId = orderId). PaymentConfirmed/Failed vêm do
// webhook do MP; PaymentRefunded vem do consumo de OrderCancelled.
@Injectable()
